...
// wyw的课程表
const OTHER_COURSES = [
  ['【08:00-11:30】地理教学设计（立C102）'], // 周一
  ['【08:50-12:20】课程与教学论（立C101）','【14:00-17:30】中国式现代化（劝C506）'], // 周二
  ...
  USERS: [
    {
      ...
      useTemplateId: 'QLzwVsVkswg3O37L78ZESd15h-2eHx86Q9bwC-N_WYc',
      ...
      courseSchedule: {
        ...
        courses: {
          ...
          even: [
            ['今天没课，专注工作'], // 周一
            ['【14:00-15:50】行星科学基础（智华113）'], // 周二
            ['【14:00-15:50】跆拳道助教(综训馆)'],// 周三
            ['今天没课，专注工作'], // 周四
            ['【10:20-12:10】行星科学基础（智华113）'],// 周五
            ['今天没课，好好休息呀'],              // 周六
            ['今天没课，好好休息呀']               // 周日
          ]
        }
